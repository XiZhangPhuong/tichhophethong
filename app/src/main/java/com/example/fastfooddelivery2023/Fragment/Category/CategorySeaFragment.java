...
public class CategorySeaFragment extends Fragment {
    private View mView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_category_sea,container,false);
                ...
                dataFood.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            if(f.getCategory_Food().equals("Hải sản")){
                                list.add(f);
