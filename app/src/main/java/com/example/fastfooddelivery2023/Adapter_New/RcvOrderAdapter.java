...
public class RcvOrderAdapter extends RecyclerView.Adapter<RcvOrderAdapter.ViewHolder> {
    ...
    private SearchAdapter.ClickSearchFood clickSearchFood;

    public RcvOrderAdapter(Context context, List<Food> listFood, SearchAdapter.ClickSearchFood clickSearchFood) {
